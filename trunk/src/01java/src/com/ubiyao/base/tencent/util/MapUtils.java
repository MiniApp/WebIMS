...
public class MapUtils {
    ...
    public static Map<String, String> putMapNotEmptyValue(Map<String, String> parasMap, String pARA_FORMAT, String format) {
        return parasMap;
    }
    public static Map<String, String> putMapNotEmptyValue(Map<String, String> parasMap, String pARA_FORMAT, String format, String tmp) {
        return parasMap;
    }
}
